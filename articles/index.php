...
if (isset($_SESSION['user_id'])) {
    if (check_user_permissions($_SESSION['user_id'], 3)) {
        ...
        $recent_article_sql = "SELECT * FROM article LIMIT 10";
        ...
        while ($article = $articles->fetch_array()){
            ...
            echo "<tr><td>$date</td><td>$title</td><td>$content</td><td><a href='edit.php?article_id=$id'><i class=\"far fa-edit\"></i></a>&nbsp;<a href='delete.php?article_id=$id'><i class=\"far fa-trash-alt\"></i></a></td></tr>";
        }
